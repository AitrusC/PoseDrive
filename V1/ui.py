...
def BilibiliLink():
    url = r"https://www.bilibili.com/video/BV1oB4y1d7qF"
    try:
    ...
    def _createMenBar(self):
        qss = """
            ...
            QMenuBar::item:selected {
                background-color: rgb(107, 115, 137);
            }
            QMenuBar::item:pressed {
                background-color: rgb(127, 135, 157);
            }
            QMenu {
                background-color: rgb(80, 89, 110);
                font: bold 7pt Microsoft YaHei;
                color: rgb(248, 244, 237)
            }
            QMenu::item:selected {
                background-color: rgb(107, 115, 137);
        ...
        tool_menu = self.menu_bar.addMenu(u"帮助")
        tool_menu.addAction(u"工具说明", BilibiliLink)
